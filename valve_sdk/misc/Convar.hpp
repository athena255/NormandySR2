...
public:
    ...
    ConCommand(const char *pName, ICommandCallback *pCallback,
        const char *pHelpString = 0, int flags = 0, void *pCommandCompletionCallback = 0);
...
public:
    ...
    virtual int GetChangeCallbackCount();
    virtual FnChangeCallback_t GetChangeCallback(int slot);
